...
def _publish_article_content_idea_to_titles(
    ...
    *,
    ...
    title_payload = {
        ...
        "topic_id": idea.get("topic_id"),
        "seo_optimization_score": idea.get("seo_optimization_score"),
        "readability_score": idea.get("readability_score"),
        "viral_potential_score": idea.get("viral_potential_score"),
        "total_search_volume": idea.get("total_search_volume"),
        "avg_keyword_difficulty": idea.get("average_difficulty") or idea.get("avg_keyword_difficulty"),
        "difficulty_level": idea.get("difficulty_level"),
        "estimated_reading_time": idea.get("estimated_reading_time"),
        "target_audience": idea.get("target_audience"),
        "supporting_entities_json": idea.get("supporting_entities_json") or idea.get("entities"),
        "priority_questions_json": idea.get("priority_questions_json") or idea.get("questions"),
