...
SUPABASE_URL=https://sbcontent.buildomain.com
...
DATABASE_URL=postgresql://postgres:your-password-here@sbcontent.buildomain.com:5432/postgres?sslmode=require
...
1. **Supabase URL**: `https://sbcontent.buildomain.com` - Your self-hosted Supabase instance
...
- `SERVICE_FQDN_SUPABASEKONG=sbcontent.buildomain.com`
- `SERVICE_URL_SUPABASEKONG=https://sbcontent.buildomain.com`
