...
class ResearchRebuildService {
    ...
    async listDataforseoSearches(params: {
        ...
        primary_category_id?: string
        secondary_category_id?: string
        search_type?: 'related_keywords' | 'keyword_suggestions' | 'expansion_funnel' | 'keyword_overview' | 'serp' | 'google_trends' | 'serp_probe' | 'ranked_keywords' | 'relevant_pages' | 'categories_for_domain' | 'category_index'
        limit?: number
