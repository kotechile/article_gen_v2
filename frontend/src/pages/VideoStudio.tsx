...
const shouldDefaultToUpload = (_scene: Scene): boolean => {
    // Default to 'auto' (Auto AI Flux) so a visual asset is always generated by default.
    // Users can still select 'Upload Custom' in the UI if they want to upload custom screenshots.
    return false;
};
                                    ...
                                    <div className="pt-2 border-t border-border/50">
                                        <label className="flex items-center gap-2.5 cursor-pointer select-none">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-[10px] text-muted-foreground">Automatically detect and calculate scene durations from voiceover scripts upon compilation</span>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                        ...
                                        <div key={scene.sceneId} className="p-4 rounded-xl border border-border bg-background shadow-md space-y-4">
                                            <div className="flex items-center justify-between border-b border-border pb-2">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <div className="flex items-center gap-1" title={blueprint?.metadata?.autoSyncTimings ?? true ? "Auto-Sync is enabled: duration will be calculated from voiceover speech length upon compile" : undefined}>
                                                        <input
                                                            type="number"
                                                            min="1"
                                                            max="60"
